...
// Initialise Publisher
    ...
    radar_state_publisher_ = this->create_publisher<radar_conti_ars408_msgs::msg::RadarState>(pub_radar_state_topic_name, qos);
    object_status_publisher_ = this->create_publisher<radar_conti_ars408_msgs::msg::ObjectStatus>(pub_object_status_topic_name, qos);
    cluster_status_publisher_ = this->create_publisher<radar_conti_ars408_msgs::msg::ClusterStatus>(pub_cluster_status_topic_name, qos);
    ...
    const rclcpp_lifecycle::State&) 
{
    ...
    radar_state_publisher_->on_activate();
    object_status_publisher_->on_activate();
    cluster_status_publisher_->on_activate();
...
// 2. if Radar Output Mode ==1 in Radar State Message -> call handle_object_list function
            ...
            if (msg.id == ID_RadarState) {
                ...
                radar_conti_ars408_msgs::msg::RadarState RdState;
                RdState.header.stamp = rclcpp_lifecycle::LifecycleNode::now();
                RdState.header.frame_id = frame_id_; 

                RdState.radarstate_nvmwritestatus.data =
                CALC_RadarState_RadarState_NVMwriteStatus(GET_RadarState_RadarState_NVMwriteStatus(msg.data), 1.0);
                RdState.radarstate_nvmreadstatus.data = 
                CALC_RadarState_RadarState_NVMReadStatus(GET_RadarState_RadarState_NVMReadStatus(msg.data), 1.0);
                RdState.radarstate_maxdistancecfg.data = 
                CALC_RadarState_RadarState_MaxDistanceCfg(GET_RadarState_RadarState_MaxDistanceCfg(msg.data), 1.0);
                RdState.radarstate_persistent_error.data = 
                CALC_RadarState_RadarState_Persistent_Error(GET_RadarState_RadarState_Persistent_Error(msg.data), 1.0);
                RdState.radarstate_interference.data = 
                CALC_RadarState_RadarState_Interference(GET_RadarState_RadarState_Interference(msg.data), 1.0);
                RdState.radarstate_temperature_error.data = 
                CALC_RadarState_RadarState_Temperature_Error(GET_RadarState_RadarState_Temperature_Error(msg.data), 1.0);
                RdState.radarstate_temporary_error.data = 
                CALC_RadarState_RadarState_Temporary_Error(GET_RadarState_RadarState_Temporary_Error(msg.data), 1.0);
                RdState.radarstate_voltage_error.data = 
                CALC_RadarState_RadarState_Voltage_Error(GET_RadarState_RadarState_Voltage_Error(msg.data), 1.0);
                RdState.radarstate_radarpowercfg.data = 
                CALC_RadarState_RadarState_RadarPowerCfg(GET_RadarState_RadarState_RadarPowerCfg(msg.data), 1.0);
                RdState.radarstate_sortindex.data = 
                CALC_RadarState_RadarState_SortIndex(GET_RadarState_RadarState_SortIndex(msg.data), 1.0);
                RdState.radarstate_sensorid.data = 
                CALC_RadarState_RadarState_SensorID(GET_RadarState_RadarState_SensorID(msg.data), 1.0);
                RdState.radarstate_motionrxstate.data = 
                CALC_RadarState_RadarState_MotionRxState(GET_RadarState_RadarState_MotionRxState(msg.data), 1.0);                
                RdState.radarstate_sendextinfocfg.data = 
                CALC_RadarState_RadarState_SendExtInfoCfg(GET_RadarState_RadarState_SendExtInfoCfg(msg.data), 1.0);
                RdState.radarstate_sendqualitycfg.data = 
                CALC_RadarState_RadarState_SendQualityCfg(GET_RadarState_RadarState_SendQualityCfg(msg.data), 1.0);
                RdState.radarstate_outputtypecfg.data = 
                CALC_RadarState_RadarState_OutputTypeCfg(GET_RadarState_RadarState_OutputTypeCfg(msg.data), 1.0);
                RdState.radarstate_ctrlrelaycfg.data = 
                CALC_RadarState_RadarState_CtrlRelayCfg(GET_RadarState_RadarState_CtrlRelayCfg(msg.data), 1.0);
                RdState.radarstate_rcs_threshold.data = 
                CALC_RadarState_RadarState_RCS_Threshold(GET_RadarState_RadarState_RCS_Threshold(msg.data), 1.0);
                
                radar_state_publisher_->publish(RdState);

            }
            if (msg.id == ID_Obj_0_Status) {
                radar_conti_ars408_msgs::msg::ObjectStatus ObjStat;
                ObjStat.obj_nofobjects.data = 
                CALC_Obj_0_Status_Obj_NofObjects(GET_Obj_0_Status_Obj_NofObjects(msg.data), 1.0);
                ObjStat.obj_meascounter.data = 
                CALC_Obj_0_Status_Obj_MeasCounter(GET_Obj_0_Status_Obj_MeasCounter(msg.data), 1.0);
                ObjStat.obj_interfaceversion.data = 
                CALC_Obj_0_Status_Obj_InterfaceVersion(GET_Obj_0_Status_Obj_InterfaceVersion(msg.data), 1.0);
                object_status_publisher_->publish(ObjStat);
            }
            if (msg.id == ID_Cluster_0_Status) {
                radar_conti_ars408_msgs::msg::ClusterStatus CluStat;
                CluStat.cluster_nofclustersnear.data = 
                CALC_Cluster_0_Status_Cluster_NofClustersNear(GET_Cluster_0_Status_Cluster_NofClustersNear(msg.data), 1.0);
                CluStat.cluster_nofclustersfar.data = 
                CALC_Cluster_0_Status_Cluster_NofClustersFar(GET_Cluster_0_Status_Cluster_NofClustersFar(msg.data), 1.0);
                CluStat.cluster_meascounter.data = 
                CALC_Cluster_0_Status_Cluster_MeasCounter(GET_Cluster_0_Status_Cluster_MeasCounter(msg.data), 1.0);
                CluStat.cluster_interfaceversion.data = 
                CALC_Cluster_0_Status_Cluster_InterfaceVersion(GET_Cluster_0_Status_Cluster_InterfaceVersion(msg.data), 1.0);
                cluster_status_publisher_->publish(CluStat);
            }
            //no output
