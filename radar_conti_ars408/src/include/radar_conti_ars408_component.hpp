...
//create Publisher
    ...
    std::string pub_radar_state_topic_name = "/ars408/radarstate";
    rclcpp_lifecycle::LifecyclePublisher<radar_conti_ars408_msgs::msg::RadarState>::SharedPtr radar_state_publisher_;
    std::string pub_object_status_topic_name = "/ars408/objectstatus";
    rclcpp_lifecycle::LifecyclePublisher<radar_conti_ars408_msgs::msg::ObjectStatus>::SharedPtr object_status_publisher_;
    std::string pub_cluster_status_topic_name = "/ars408/clusterstatus";
    rclcpp_lifecycle::LifecyclePublisher<radar_conti_ars408_msgs::msg::ClusterStatus>::SharedPtr cluster_status_publisher_;
